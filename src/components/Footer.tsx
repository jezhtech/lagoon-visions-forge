        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Link to="/products/corex" className="block text-background/80 hover:text-primary transition-colors">
                coreX ERP
              </Link>
              <Link to="/products/timetick" className="block text-background/80 hover:text-primary transition-colors">
                Time Tick
              </Link>
              <Link to="/products/safex365" className="block text-background/80 hover:text-primary transition-colors">
                safeX365
              </Link>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Link to="/career" className="block text-background/80 hover:text-primary transition-colors">
                Career
              </Link>
              <Link to="/blog" className="block text-background/80 hover:text-primary transition-colors">
                Blog
              </Link>
              <Link to="/documentation" className="block text-background/80 hover:text-primary transition-colors">
                Documentation
              </Link>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-background/80">info@lagoontechnologies.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="w-5 h-5 text-primary" />
                <span className="text-background/80">+971 XX XXX XXXX</span>
              </div>
